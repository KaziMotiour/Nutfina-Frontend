...
const SidebarFilter = ({
  ...
  useEffect(() => {
    ...
    const isSame =
      ...
      urlCategories.length === selectedCategory.length &&
      urlCategories.every((c) => selectedCategory.includes(c));
    if (!isSame) {
      dispatch(setSelectedCategory(urlCategories));
      setCurrentPage(1);
    }
  ...
  const handleCategoryChange = (category) => {
    ...
    // Remove existing category params then append all selected
    params.delete("category");
    updatedCategory.forEach((cat) => params.append("category", cat));
            ...
            <div className="gi-sidebar-block">
              ...
              <div className="gi-sb-block-content">
                <ul>
                  ...
                  {categoryData.slice(0, 2).map((category: any, index: number) => (
                    <li key={index}>
